    ...
    packages: [
      {
        name: 'الراعي الرئيسي',
        price: 'حصرية',
        features: ['تسمية المهرجان', '2 بوث مميزة', 'تسمية المسرح الرئيسي', 'شعار في كل المواد التسويقية'],
        action: 'تواصل معنا',
      ...
      },
      {
        name: 'راعي منطقة',
        price: 'مخصص',
        features: ['تسمية منطقة كاملة', 'بوث كبيرة', '3 منشورات أسبوعية', 'تفاعل مباشر'],
        action: 'تواصل معنا',
        link: 'mailto:info@alahsashopping.com'
      },
      {
        name: 'تاجر محلي',
        price: 'من 5,000 ر.س',
        features: ['بوث في السوق', 'مشاركة في العروض', 'نظام مسح للعملاء', 'دعم فني'],
        action: 'سجل الآن',
        link: '/apply'
      }
    ],
